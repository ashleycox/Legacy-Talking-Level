...
void transNum(float n) {
  ...
  r1 = n;
  //Work out the decimal and convert to an absolute value
  r2 = abs(n * 10 - r1 * 10);
  //A second decimal, also as an absolute value
  r3 = abs(n * 100 - r1 * 100);

  //Uncomment to print individual numbers to the serial monitor
  //  Serial.println("Individual Numeric Values are: ");
  //  Serial.println(r1);
  //  Serial.println(r2);
  //  Serial.println(r3 / 100);

  //Finally, speak the reading
  speakNum(r1);
  if (pt > 1) {
    voice.say(spPOINT);
    if (pt == 2) {
